...
efficiency_input = "/home/submit/xiaot425/IAP2026/efficiency/efficiency_applied_output/nointer_signal_with_efficiency.h5"
...
for i in range(ntoys):
    ...
    if args.toy:
        ...
        Nsig.set_value(float(datatoy["fit_weight"].sum()))
    else:
        datatoy = datai.copy()
    ...
    if i < 3 and wA0_cow is not None and wApp_cow is not None and wAS_cow is not None:
        ...
        outdir_cow = f"plots/{args.polynomial}/{name}/reference_cow_Iq_realistic_weighted_signal_only_manual_nointer"
        ...
        make_cow_extracted_only_plot(
            ...
            data_label=r"$A_q$ COW projection",
        )
    ...
    # Plot the result
    if i < 3:
        outdir_fit = f"plots/{args.polynomial}/{name}/fit_projections_cow_Iq_realistic_weighted_signal_only_manual_nointer"
